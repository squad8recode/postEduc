					...
					<Form	noValidate
						...
						<Form.Row>
							<Col>
								<Form.Group>
									...
									<Form.Control type='url' name='lin' placeholder='https://' required/>
									<Form.Control.Feedback type='invalid'>
										Por favor preencha esse campo.
									</Form.Control.Feedback>
								</Form.Group>
						...
						<Form.Row>
							...
							<Col sm={12} md={12} lg={4}>
								<Form.Group>
									<Form.Label>
										CEP <span style={field_required}>*</span>{' '}
									</Form.Label>
									<Form.Control
										type='text'
										name='cep'
						...
						<Form.Row>
							<Col>
								<Form.Group>
									<Form.Label>
										Estado(UF) <span style={field_required}>*</span>{' '}
									</Form.Label>
									<Form.Control
										type='text'
										name='estado'
							...
							<Col>
								<Form.Group>
									<Form.Label>
										Endereço <span style={field_required}>*</span>{' '}
									</Form.Label>
									<Form.Control
										type='text'
										name='logradouro'
						...
						<Form.Row>
							...
							<Col>
								<Form.Group>
									<Form.Label>
										Número <span style={field_required}>*</span>
									</Form.Label>
						...
						<Form.Row>
							...
							<Col>
								<Form.Group>
									<Form.Label>
										Complemento <span style={field_required}>*</span>{' '}
									</Form.Label>
						...
						<Form.Row>
							<Col>
								<Form.Group>
									<Form.Label>
										{' '}
										Descreva sua atividade <span style={field_required}>
											*
										</span>{' '}
									</Form.Label>
									<textarea
